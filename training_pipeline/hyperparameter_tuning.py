...
import utils
from config import gridsearch as gridsearch_config
...
def run(
    ...
    y_train, _, X_train, _ = load_data_from_feature_store(
...
def run_hyperparameter_optimization(
    ...
    sweep_id = wandb.sweep(
        sweep=gridsearch_config.sweep_configs, project=SETTINGS["WANDB_PROJECT"]
    )
    wandb.agent(
