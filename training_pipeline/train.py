...
from model import build_model, baseline_model
...
def from_best_config(
    ...
    y_train, y_test, X_train, X_test = load_data_from_feature_store(
    ...
    with utils.init_wandb_run(
        ...
        # # Baseline model
        baseline_forecaster = baseline_model(seasonal_periodicity=fh)
